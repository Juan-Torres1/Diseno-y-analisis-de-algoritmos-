"""
La clase grafo posee un diccionario para almacenar objetos 
de tipo nodo y las aristas se guardan en una estructura tipo set
"""
...
class Grafo:
    ...
    def layout(self):
        ...
        def dibujar_nodo(x, y):
            ...
            pos = (x * WITH, y * HEIGHT)
            pygame.draw.circle(WIN, (0, 86, 59),
                               pos, 8)
        ...
        def dibujar_arista(xy, xj, yx, yj):
            ...
            pygame.draw.line(WIN, (65, 68, 67), pos1, pos2, 1)

        def actualizar_nodo(i):
            posx = int(x[i][0] * WITH) / WITH
            posy = int(x[i][1] * HEIGHT) / HEIGHT
        ...
        def actualizar_arista(xi, xj):
            ...
            newposxy = int(xi[0] * WITH)
            newposxj = int(xi[1] * HEIGHT)
            newposyx = int(xj[0] * WITH)
            newposyj = int(xj[1] * HEIGHT)
