"""
Metodo para guardar el grafo
Se utiliza la libreria pydot para hacer una traduccion de nuestro grafo a lenguage .dot
y guardar el archivo en un archivo graphviz(.gv)
"""
import pydot
import os
import tempfile
