...
# Lista de costos del MST

nombres = [
    "grafo_malla_50",
    "grafo_malla_500",
    "grafo_erdos_50_250",
    "grafo_erdos_500_2500",
    "grafo_gilbert_50_05",
    "grafo_gilbert_500_002",
    "grafo_geografico_50_05",
    "grafo_geografico_500_01",
    "grafo_babarasi_50_10",
    "grafo_babarasi_500_12",
    "grafo_dorogovtsev_mendes_50",
    "grafo_dorogovtsev_mendes_500",
]
grafos = [
    grafo_malla_50,
    grafo_malla_500,
...
for nombre, grafo in zip(nombres, grafos):
    costos_kruskali.append((nombre, grafo.KruskalI().costo()))
    costos_kruskald.append((nombre, grafo.KruskalD().costo()))
    costos_prim.append((nombre, grafo.Prim().costo()))

print("Lista de costos de los MST (KruskalI):")
print(costos_kruskali)
print("Lista de costos de los MST (KruskalD):")
print(costos_kruskald)
print("Lista de costos de los MST (Prim):")
print(costos_prim)