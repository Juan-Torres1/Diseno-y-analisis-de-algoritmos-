"""
En el metodo para guardar el grafo mediante el uso de la libreria pydot se hace
una traduccion de nuestro grafo a lenguage .dot y se guarda en un archivo graphviz(.gv)
"""
